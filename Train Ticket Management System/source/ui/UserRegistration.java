...
//parameterless constructor
    ...
    public void actionPerformed(ActionEvent e) {
       if(e.getSource()==register){
          ...
          String pd1=new String(password.getPassword());

          String pd2=new String(confirmPassword.getPassword());


              if(name.getText().equals("") ||username.getText().equals("")||email.getText().equals("")||pd1.equals("")||pd2.equals("") ||male.isSelected()==false&&female.isSelected()==false){
              ...
              User user=new User(new String[]{name.getText(),username.getText(),email.getText(),pd1,dob.getText(),"Male"});
              ...
              JOptionPane.showMessageDialog(this, "User not Registered.", "Notification", JOptionPane.INFORMATION_MESSAGE);
